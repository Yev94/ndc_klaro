var klaroConfig = {
  ...
  urlPoliticas: {
    cookies: {
      es: '/delphina/politica-de-cookies/',
      en: '/delphina/politica-de-cookies/',
      pt: '/delphina/politica-de-cookies/',
      it: '/delphina/politica-de-cookies/',
    },
    privacidad: {
      es: '/delphina/politica-de-privacidad/',
      en: '/delphina/politica-de-privacidad/',
      pt: '/delphina/politica-de-privacidad/',
      it: '/delphina/politica-de-privacidad/',
    }
  },
  corp_color: "#BF9259",
  cssColor: "",
...
klaroConfig.cssUnderline = ".klaro .cn-decline[type=button],.klaro .context-notice .cm-btn.cm-btn-info,.klaro .cookie-modal .cm-btn.cm-btn-info,.klaro .cookie-notice .cm-btn.cm-btn-info{text-decoration:" + klaroConfig.underlineLinks + "}.klaro .context-notice a,.klaro .cookie-modal a,.klaro .cookie-notice a{color:var(--corporative-color);color:var(--green1,var(--corporative-color));text-decoration:" + klaroConfig.underlineLinks + "}";
